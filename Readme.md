...
This is UI design Landing page of a SAAS Website this is fully designed using core `HTML` and `CSS`.
and this is responsive for mobile screens and laptop screens of 480px
